...
Each document defines required product behaviour and data model.

## 2. Document register

| Ref | Title | Version |
|-----|-------|---------|
| P1-00 | [Phase 1 Overview](./phase-1-overview.md) | 0.4 |
| P1-01 | Core User Workflow | 1.0 |
| P1-01-Admin | [Core Operator Workflow — Admin Console](./P1-01-admin.md) | 2.5 |
| P1-01-User | [Core Analyst Workflow](./P1-01-user.md) | 1.7 |
| P1-02-Admin | [Core Product Objects — Admin Console](./P1-02-admin.md) | 1.1 |
| P1-02-User | [Core Product Objects](./P1-02-user.md) | 1.2 |
| P1-03 | [Object Relationships](./P1-03.md) | 1.2 |
| P1-04 | [Required Fields — Admin & Analyst](./P1-04-admin.md) | 2.2 |
| P1-05-Admin | [UI Screen Mapping — Admin Console](./P1-05-admin.md) | 1.0 |
| P1-05-User | [UI Screen Mapping — Analyst App](./P1-05-user.md) | 1.0 |
| P1-06 | [Backend Actions](./P1-06.md) | 1.0 |
| P1-07 | MVP Scope Boundaries | — |
