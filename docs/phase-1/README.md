...
|-----|-------|------|---------|--------|
| P1-00 | **Phase 1 Overview** | [phase-1-overview.md](./phase-1-overview.md) | 1.3 | Current |
...
| P1-02-Admin | Core Product Objects (Admin) | [P1-02-admin.md](./P1-02-admin.md) | 2.2 | Current — paired with User |
| P1-02-User | Core Product Objects | [P1-02-user.md](./P1-02-user.md) | 2.2 | Current — paired with Admin |
| P1-03 | Object Relationships | [P1-03.md](./P1-03.md) | 2.2 | Current |
| P1-04-Admin | Required Fields | [P1-04-admin.md](./P1-04-admin.md) | 3.3 | Current |
| P1-05-Admin | UI Screen Mapping (Admin) | [P1-05-admin.md](./P1-05-admin.md) | 2.2 | Current |
...
| [docs/api/ORG_USER_SETUP.md](../api/ORG_USER_SETUP.md) | Organization / user admin API (migration `0012`) |
| [docs/api/API_CONTRACT_PLAN.md](../api/API_CONTRACT_PLAN.md) | External API contract roadmap |
| `apps/web/src/App.tsx` | Legacy operator frontend route definitions |
| `apps/web/src/lib/api.ts` | Legacy operator frontend API client |
